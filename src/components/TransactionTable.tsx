...
const TransactionsTable: React.FC<TransactionsTableProps> = ({
  ...
  return (
    <div className="mt-5 text-[#1B2528] overflow-x-auto">
      <table className="border-seperate table-fixed w-full">
        <thead>
          <tr className="text-left">
            <th
              onClick={toggleSort}
              className="table-item text-[#15272D]/60 w-30 md:w-84"
            >
              <div className="border-b-2 border-[#49656E]/20">
                Date {sortAsc ? "▲" : "▼"}
              </div>
            </th>
            <th className="table-item text-[#15272D]/60 w-40 md:w-50">
              <div className="border-b-2 border-[#49656E]/20">Remark ▼</div>
            </th>
            <th className="table-item text-[#15272D]/60 w-35">
